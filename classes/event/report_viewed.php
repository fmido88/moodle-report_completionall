...
namespace report_completionall\event;
...
class report_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventreportviewed', 'report_completionall');
    }
    ...
    public function get_url() {
        return new \moodle_url('/report/completion/index.php', ['course' => $this->courseid]);
    }
